...
router.post('/register', function(req, res) {
  Account.register(new Account({ lastname : req.body.lastname, firstname : req.body.firstname, department : req.body.department, phone:req.body.phone, username:req.body.email, password: req.body.password}), function(err, account) {
    if (err) {
      console.log(err);
